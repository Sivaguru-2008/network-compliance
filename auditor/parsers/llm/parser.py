...
FIELD_TYPES: Dict[str, Any] = {
    ...
    "usb_auto_install_disabled": bool,
    "ssl_static_key_ciphers_disabled": bool,
    "strong_crypto_enabled": bool,
    "admin_tls13_only": bool,
    "management_min_tls_version": str,
    "gui_cdn_enabled": bool,
    "log_single_cpu_high_enabled": bool,
    "admin_lockout_threshold": int,
    "admin_lockout_duration": int,
    "admin_default_ports_changed": bool,
    "pre_login_banner_present": bool,
    "post_login_banner_present": bool,
    "snmp_agent_enabled": bool,
    "snmp_v3_users_present": bool,
